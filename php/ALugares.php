<?php
 ...
 if(isset($_POST['submit'])){
    ...
    $idL=$mysqli->real_escape_string($_POST['id']);

    $query= 'UPDATE informacionlugares  SET nombreLugares="'.$nombre.'", tipoLugar="'.$tipo.'" , InformacionLugares="'.$inf.'" , DireccionLugares ="'.$direc.'", DLlat="'.$dlat.'", DLlong="'.$dlong.'", estadoLugar="'.$estado.'" WHERE idInformacionLugares="'.$idL.'"';
