<?php
  ...
  $query='SELECT empresasuscrita.idEmpresaSuscrita, empresasuscrita.NombreEmpresa, empresasuscrita.RubroEmpresa, empresasuscrita.NTelefonoEmpresa, empresasuscrita.CorreoEmpresa, empresasuscrita.estadoEmpresa, usuario.UsuarioNombre from (empresasuscrita INNER JOIN usuario ON empresasuscrita.Usuario_idUsuario = usuario.idUsuario);';
                            ...
                            <table class="table table-hover" id="myTable">
                                    ...
                                    <tbody>
                                      ...
                                      <?php
                                          ...
                                          ?>
                                        <td><?php echo $row['idEmpresaSuscrita'] ?></td>
                                        <td><?php echo $row['NombreEmpresa'] ?></td>
                                        <td><?php echo $row['RubroEmpresa'] ?></td>
                                        <td><?php echo $row['NTelefonoEmpresa'] ?></td>
                                        <td><?php echo $row['CorreoEmpresa'] ?></td>
                                        <td><?php echo $row['estadoEmpresa'] ?></td>
                                        <td><?php echo $row['UsuarioNombre'] ?></td>
                                        <td><a href="Actualizar/index.php?id=<?php echo $row['idEmpresaSuscrita'] ?>" style="color:#000;"><i class="fas fa-edit"></td>
                                      </tr>
                                      <?php
                                            }
                                          ?>
