<?php
  ...
  $query='SELECT idInformacionLugares, DireccionLugares, nombreLugares, estadoLugar FROM informacionlugares';
            ...
            <div class="row">
                <div class="col-lg-12 mt-5">
                    <div class="mt-5 nani1">
                            <h2><strong>Modulo Lugares</strong></h2>
                            <hr><br>
                            <div >
                              <a class="btn btn-warning icon-user-plus mt-1" style="color:#fff;" href="CrearL/">Agregar Nuevo Lugar</a>
                            ...
                            <table class="table table-hover" id="myTable">
                                    <thead class="thead-dark">
                                      <tr>
                                        ...
                                        <th scope="col">Direccion Lugar</th>
                                    ...
                                    <?php
                                          ...
                                          <tr>
                                      <tr>
                                        <td><?php echo $row['idInformacionLugares'] ?></td>
                                        <td><?php echo $row['nombreLugares'] ?></td>
                                        <td><?php echo $row['DireccionLugares'] ?></td>
                                        <td><?php echo $row['estadoLugar'] ?></td>
                                        <td><a href="ActualizarL/index.php?id=<?php echo $row['idInformacionLugares'] ?>" style="color:#000;"><i class="fas fa-edit"></i> </a></td>
                                      </tr>
                                      <?php
                                            }
                                          ?>
