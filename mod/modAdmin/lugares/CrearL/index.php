            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-5">
                    <div class="mt-5 nani1">
                        <h2 class="" >Formulario Registro Lugares</h2>
                        <p></p>
                        <form>
                            <div class="form-group">
                                <label for="exampleFormControlInput1"> <strong>Nombre Lugar</strong>  </label>
                                ...
                                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="xxxx calle balmaceda">
                                ...
                                <div class="form-group">
                                        <label for="exampleFormControlTextarea1"><strong>Información del Lugar</strong></label>
