...
<html lang="es">
  ...
  <body>
    ...
    <form action="/php/GLugares.php" method="POST" enctype='multipart/form-data'>
    <!--Banner Empresa-->
                        ...
                        <div class="row">
                            <div class="nani col-lg-8">
                              ...
                              <div class="form-group heading mt-2 offset-lg-3 col-lg-6">
                                  ...
                                  <h3><input type="text" id="nombre" class="form-control" name="nombre" placeholder="Nombre del Lugar" required></h3>
                                  <hr>
                              </div>
