            ...
            <div class="row">
                <div class="col-lg-12 mt-5">
                    <div class="mt-5 nani1">
                            <h2><strong>Modulo Administración de Restaurantes</strong></h2>
                            <hr><br>
                            <div >
                              <a class="btn btn-warning icon-user-plus mt-1" style="color:#fff;" href="crearR/">Agregar Nuevo Restaurante</a>
