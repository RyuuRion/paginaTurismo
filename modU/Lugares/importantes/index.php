<?php
  ...
  $query='SELECT idInformacionLugares, nombreLugares, InformacionLugares FROM informacionlugares WHERE tipoLugar="Importante"';
                ...
                <div class="loop">
                  ...
                  <?php
                      ...
                      <div class="row mt-2">
                        <div class="col-sm-3">
                           <div class="img-list">
                             <a href="lugaresImportantes/index.php?id=<?php echo $lugares['idInformacionLugares']?>">                         
                              <?php
                                  if(file_exists($path)){
                        ...
                        <div class="col-sm-6">
                            <div class="info">
                                <h3><a href="lugaresImportantes/index.php?id=<?php echo $lugares['idInformacionLugares']?>"><?php echo $lugares['nombreLugares']; ?></a></h3>
                        ...
                        <div class="col-sm-3">
                          <div class="btn-list">
                              <div>
                                  <a href="lugaresImportantes/index.php?id=<?php echo $lugares['idInformacionLugares']?>" class="btn btn-1 ">Ver detalles</a>
                              </div>
                            </div>
                          </div>
                        </div>
