<?php
  ...
  $query='SELECT nombreLugares ,nombreLugares, InformacionLugares, DireccionLugares, DLlat,  DLlong FROM informacionlugares WHERE idInformacionLugares= "'.$idL.'"';
  ...
  $lugares= mysqli_fetch_assoc($resultado);
?>
<!doctype html>
<html lang="es">
  <head>
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner banner-imgPrincipal">
                ...
                if(file_exists($path)){
                  ...
                  while ($archivo = readdir($directorio))
                  {
                    if (!is_dir($archivo)){
                      ...
                      echo "<img src='../../../img/lugares/$idL/$archivo' id='banner-Empresa' name='imgbannerP' class='w-100 d-block' /> </div>";
                  }
                }
              }
              ?>
              ...
              <div class="carousel-caption d-none d-md-block">
                    <h1><?php echo $lugares['nombreLugares']?></h1>
              </div>
          </div>
      </div>
                ...
                <div class="row">
                    <div class="col-lg-7 nani">
                            ...
                            <div class="heading mt-2">
                                <h3><?php echo $lugares['nombreLugares']?></h3>
                                    <hr>
                            </div>
                            <div class="cargarinfo text-justify">
                              <?php echo $lugares['InformacionLugares']?>
                            </div>
                    </div>
                    <aside class="col-lg-4 mx-4">
                        <div class="nani1">
                                <div class="heading">
                                    ...
                                    <div class="cargarDireccion">
                                        <h5><?php echo $lugares['DireccionLugares']?></h5> <hr>
                                        <div class="mt-1">
                                            <div style="width: 100%">
                                              <iframe width="100%" height="200" src="https://maps.google.com/maps?width=100%&height=200&hl=es&coord=<?php echo $lugares['DLlat']?>, <?php echo $lugares['DLlong']?>&ie=UTF8&t=&z=16&iwloc=B&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div><br />
                                            </div>
                                        </div> <hr>
                                    </div>
                        </div>
