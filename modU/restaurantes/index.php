<?php 
  ...
  $query2='SELECT idEmpresaSuscrita, NombreEmpresa, InformacionEmpresa FROM empresasuscrita WHERE RubroEmpresa="Restaurantes"';
                ...
                <div class="loop">
                  ...
                  ?>
                      <div class="row">
                          <div class="col-sm-3">
                            <div class="img-list">
                              <a href="/modU/restaurantes/restaurantesP/index.php?id=<?php echo $EmpresaR['idEmpresaSuscrita']; ?>">
                              <?php
                                  if(file_exists($path)){
                                    $directorio = opendir($path);
                                    while ($archivo = readdir($directorio)){
                                        if (!is_dir($archivo)){
                                          echo "<img src='/img/$idE/$archivo' class='d-block' style='width:100%;'>";             
                                        }
                                    }
                                }
                                ?> 
                          ...
                          <div class="col-sm-6">
                              <div class="info">
                                  <h3><a href="/modU/restaurantes/restaurantesP/index.php?id=<?php echo $EmpresaR['idEmpresaSuscrita']; ?>"><?php echo $EmpresaR['NombreEmpresa']; ?></a></h3>
                                  <div class=" text-justify">
                                    <?php echo substr($EmpresaR['InformacionEmpresa'] ,0, 200)?>...
                                  </div>
                              </div>
                          </div>
                          <div class="col-sm-3">
                              <div class="btn-list">
                                <div>
                                    <a href="/modU/restaurantes/restaurantesP/index.php?id=<?php echo $EmpresaR['idEmpresaSuscrita']; ?>" class="btn btn-1 ">Ver detalles</a>
                                </div>
                              </div>
                            </div>
                        </div>
