      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner banner-imgPrincipal">
              ...
              <div class="carousel-caption d-none d-md-block">
                    <h5>Sobre El Valle del Elqui</h5>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 mt-1 mb-1">
                <a href="http://www.laserena.cl/" target="_blanc"><img src="" style="width:90px;" alt=""></a>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="row">
                    <div class="col-lg-12 nani">
                            <div class="cargarimg mt-2">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                              <div class="carousel-item active">
                                                <img src="/images/im4.jpg" class="d-block w-100" alt="...">
                                              </div>
                            ...
                            <div class="heading mt-2">
                                <h3>Datos importantes sobre El Valle del Elqui </h3>
                                    <hr>
                            </div>
                            <div class="cargarinfo">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, odit. Enim unde repudiandae repellendus voluptatem maxime, eligendi nostrum cupiditate possimus doloremque animi cum deserunt eveniet labore adipisci fuga asperiores accusantium.
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque culpa, nam totam necessitatibus ducimus repudiandae distinctio, quis voluptatem quidem, aspernatur adipisci eos. Hic incidunt fugit quis ad beatae, dolore laudantium.
                                    </p>
                            </div>
                    </div>
                </div>
