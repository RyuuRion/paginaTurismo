<?php 
  ...
  $query2='SELECT idEmpresaSuscrita, NombreEmpresa, InformacionEmpresa FROM empresasuscrita WHERE RubroEmpresa="Agencia de Turismo"';
                ...
                <div class="loop">
                  ...
                  ?>
                      <div class="row">
                          <div class="col-sm-3">
                            <div class="img-list">
                              <a href="/modU/agencias/agenciasP/index.php?id=<?php echo $EmpresaR['idEmpresaSuscrita']; ?>">
                              <?php
                                  if(file_exists($path)){
                          ...
                          <div class="col-sm-6">
                              <div class="info">
                                  <h3><a href="/modU/agencias/agenciasP/index.php?id=<?php echo $EmpresaR['idEmpresaSuscrita']; ?>"><?php echo $EmpresaR['NombreEmpresa']; ?></a></h3>
                          ...
                          <div class="col-sm-3">
                              <div class="btn-list">
                                <div>
                                    <a href="/modU/agencias/agenciasP/index.php?id=<?php echo $EmpresaR['idEmpresaSuscrita']; ?>" class="btn btn-1 ">Ver detalles</a>
                                </div>
                              </div>
                            </div>
                        </div>
